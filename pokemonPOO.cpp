        ...
        while (vidaOponente > 0 && vidaMiPok > 0){
            ...
            else
            {
...

                {
                    ...
                    cout << "Vida de " << miPok->getNombre() << ": " << vidaMiPok + dañoTotalOponente << " - " << dañoTotalOponente << " ->  0 " << endl;
            ...
            if (vidaMiPok > 0)
            {
                ...
                if(vidaOponente<0){
                                    cout << oponente->getNombre() << ": Vida: " << vidaOponente + ((ataqueMiPok + (ataqueMiPok * .4)) - ((ataqueMiPok + ataqueMiPok * .4) * 0.2)) << " - " <<((ataqueMiPok + ataqueMiPok * .4) - ((ataqueMiPok + ataqueMiPok * .4) * 0.2))  << " -> 0 " << endl;
                cout << "\n**************************************************************\n\n";
